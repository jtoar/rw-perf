...
const DEFAULT_SERVER_CONFIG = exports.DEFAULT_SERVER_CONFIG = {
  port: 22,
  branch: 'main',
...
const command = exports.command = 'baremetal [environment]';
const description = exports.description = 'Deploy to baremetal server(s)';
...
const execaOptions = exports.execaOptions = {
