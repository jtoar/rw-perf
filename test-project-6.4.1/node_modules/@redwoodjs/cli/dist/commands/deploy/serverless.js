...
const aliases = exports.aliases = ['aws serverless', 'sls'];
const description = exports.description = 'Deploy to AWS via the serverless framework';
const builder = yargs => {
  yargs.option('stage', {
...
const handler = async yargs => {
  ...
  (0, _cliHelpers.recordTelemetryAttributes)({
    ...
    sides: (0, _stringify.default)(yargs.sides),
