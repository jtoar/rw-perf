...
const POSTGRES_YAML = exports.POSTGRES_YAML = `  - key: DATABASE_URL
    fromDatabase:
...
databases:
  - name: ${PROJECT_NAME}-db
    region: oregon
`;
const SQLITE_YAML = exports.SQLITE_YAML = `  - key: DATABASE_URL
    value: file:./data/sqlite.db
  disk:
    name: sqlite-data
    mountPath: /opt/render/project/src/api/db/data
    sizeGB: 1`;
const RENDER_HEALTH_CHECK = exports.RENDER_HEALTH_CHECK = `// render-health-check
