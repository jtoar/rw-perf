...
const command = exports.command = 'flightcontrol';
const alias = exports.alias = 'fc';
const description = exports.description = 'Setup Flightcontrol deploy';
...
const updateApp = () => {
  return {
    ...
    task: _ctx => {
      ...
      const appJsPath = _path.default.join((0, _lib.getPaths)().base, 'web/src/App.jsx');
      let appPath;
...
const handler = async ({
  ...
  }, updateGraphQLFunction(), updateDbAuth(), updateApp(), (0, _helpers.updateApiURLTask)('${REDWOOD_API_URL}'), addToDotEnvDefaultTask(), (0, _lib.printSetupNotes)(notes)], {
    rendererOptions: {
