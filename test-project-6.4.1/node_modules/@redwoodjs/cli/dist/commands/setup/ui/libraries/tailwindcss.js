...
const handler = async ({
  ...
  const tasks = new _listr.Listr([{
    ...
    skip: () => {
      ...
      return !_fs.default.existsSync(_path.default.join(rwPaths.web.src, 'scaffold.css'));
    },
    task: async (_ctx, task) => {
      ...
      if (overrideScaffoldCss) {
        const tailwindScaffoldTemplate = _fs.default.readFileSync(_path.default.join(__dirname, '..', '..', '..', 'generate', 'scaffold', 'templates', 'assets', 'scaffold.tailwind.css.template'));
        _fs.default.writeFileSync(_path.default.join(rwPaths.web.src, 'scaffold.css'), tailwindScaffoldTemplate);
      } else {
