...
function updatePackageJsonVersion(pkgPath, version, {
  ...
  if (pkg.dependencies) {
    for (const depName of (0, _filter.default)(_context5 = (0, _keys.default)(pkg.dependencies)).call(_context5, x => (0, _startsWith.default)(x).call(x, '@redwoodjs/'))) {
      var _context5;
      if (verbose || dryRun) {
  ...
  if (pkg.devDependencies) {
    for (const depName of (0, _filter.default)(_context6 = (0, _keys.default)(pkg.devDependencies)).call(_context6, x => (0, _startsWith.default)(x).call(x, '@redwoodjs/'))) {
      var _context6;
      if (verbose || dryRun) {
  ...
  return new _listr.Listr((0, _map.default)(packageJsons).call(packageJsons, ({
    ...
    return {
      ...
      task: async () => {
        ...
        const localPackageJsonText = _fs.default.readFileSync(pkgJsonPath, 'utf-8');
        ...
        if (!dryRun) {
          _fs.default.writeFileSync(pkgJsonPath, (0, _stringify.default)(localPackageJson, null, 2));
        }
      },
      skip: () => !_fs.default.existsSync(pkgJsonPath)
    };
