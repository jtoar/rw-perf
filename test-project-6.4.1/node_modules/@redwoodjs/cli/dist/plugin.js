...
async function loadPlugins(yargs) {
  ...
  const pluginCommandCache = (0, _plugin.loadCommadCache)();
  ...
  const namespaces = (0, _sort.default)(_context6 = (0, _from.default)((0, _map.default)(thirdPartyPackages).call(thirdPartyPackages, p => p.split('/')[0]))).call(_context6);
  ...
  if (showingHelpAtNamespaceLevel) {
    ...
    if (namespaceInUse === '@redwoodjs') {
      ...
      var _context7;
      const packagesForNamespace = (0, _filter.default)(_context7 = (0, _from.default)(thirdPartyPackages)).call(_context7, p => (0, _startsWith.default)(p).call(p, namespaceInUse));
  ...
  if (!foundMatchingPackage) {
    for (const plugin of enabledPlugins) {
      var _context8;
      if ((0, _startsWith.default)(_context8 = plugin.package).call(_context8, namespaceInUse)) {
...
async function loadCommandsFromCacheOrPackage(packageName, cache, autoInstall, readFromCache) {
  ...
  if (cacheEntry !== undefined) {
    var _context9;
    const commands = (0, _map.default)(_context9 = (0, _entries.default)(cacheEntry)).call(_context9, ([command, info]) => {
      return {
        command,
