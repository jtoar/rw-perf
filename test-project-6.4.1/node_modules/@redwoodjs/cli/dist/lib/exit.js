...
function exitWithError(error, {
  ...
  const content = (0, _filter.default)(_context2 = [line, message, includeEpilogue && `\n${line}`, includeEpilogue && epilogue, includeReferenceCode && ` - Here's your unique error reference to quote: '${errorReferenceCode}'`, line]).call(_context2, Boolean).join('\n');
  console.error();
