...
exports.loadCommadCache = loadCommadCache;
...
function loadCommadCache() {
  ...
  try {
    const localCommandCache = JSON.parse(_fs.default.readFileSync(commandCachePath));
...
function saveCommandCache(pluginCommandCache) {
  const commandCachePath = _path.default.join((0, _index.getPaths)().generated.base, PLUGIN_CACHE_FILENAME);
  try {
    _fs.default.writeFileSync(commandCachePath, (0, _stringify.default)(pluginCommandCache, undefined, 2));
  } catch (error) {
